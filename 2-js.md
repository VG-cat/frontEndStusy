...
![](E:\桌面文件\笔记\前端笔记\images\js\QQ截图20240315224943.png)
...
## BOM（浏览器对象模型）
![](E:\桌面文件\笔记\前端笔记\images\js\Snipaste_2024-03-17_14-51-23.png)
...
![](E:\桌面文件\笔记\前端笔记\images\js\Snipaste_2024-03-22_10-32-58.png)
...
```
        ...
        div.addEventListener('mousemove',move2)
```
![](E:\桌面文件\笔记\前端笔记\images\js\Snipaste_2024-03-22_23-02-38.png)
...
![](E:\桌面文件\笔记\前端笔记\images\js\Snipaste_2024-03-12_19-11-01.png)

### js执行机制
![](E:\桌面文件\笔记\前端笔记\images\js\Snipaste_2024-03-18_13-29-42.png)
...
延时队列         优先级：高
交互队列          中
![](E:\桌面文件\笔记\前端笔记\images\js\Snipaste_2024-03-12_19-13-22.png)
...
<img src="E:\桌面文件\笔记\前端笔记\images\img\Snipaste_2024-03-27_22-01-53.png"  />
...
![](E:\桌面文件\笔记\前端笔记\images\js\QQ截图20240309221517.png)

#### 2. 样式计算style

  将dom树和cssom树整合，得到计算后的样式dom，该过程中，相对单位会变成绝对单位
![](E:\桌面文件\笔记\前端笔记\images\js\QQ截图20240309221639.png)
...
比如使用了伪元素选择器，虽然DOM中不存在为原始节点，但是由于含有几何信息，所以会生成到布局树上面。
  ![](E:\桌面文件\笔记\前端笔记\images\js\QQ截图20240309205735.png)
...
![](E:\桌面文件\笔记\前端笔记\images\js\QQ截图20240309221804.png)

#### 5. 绘制paint

  主线程会为每一个层单独创建绘制指令集，用于描述如何绘制。
  完成绘制以后，主线程将每个图层的绘制信息提交给合成线程，之后的工作交给合成线程。
  ![](E:\桌面文件\笔记\前端笔记\images\js\QQ截图20240309211658.png)

#### 6. 分块trling

  合成线程首先从线程池拿出若干线程，对每个图层进行分块工作。
  ![](E:\桌面文件\笔记\前端笔记\images\js\QQ截图20240309221901.png)

#### 7. 光栅化

  分块完成后，进入光栅化阶段。
  合成线程将信息交给GPU进行，进行高速光栅化，优先处理靠近视口区域的块，最终产生一块块的位图
 ![](E:\桌面文件\笔记\前端笔记\images\js\QQ截图20240309222109.png)
...
#### 8. 画 
  ...
  ![](E:\桌面文件\笔记\前端笔记\images\js\QQ截图20240309214706.png)
  ![](E:\桌面文件\笔记\前端笔记\images\js\QQ截图20240309215214.png)
